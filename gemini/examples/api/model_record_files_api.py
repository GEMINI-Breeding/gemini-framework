...
# Creating Records to add to ModelRecord
records_to_add = []
for image_file in sample_image_files:
    ...
    record = ModelRecord.create(
        ...
        model_name="Model A",
        dataset_name="Model A Images Dataset",
...
ModelRecord.insert(records_to_add)

# Search the Model Records
...
print(f"Found {len(searched_records)} records in Model A, Experiment A, Site A1, Season 1A:")
