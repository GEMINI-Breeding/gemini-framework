...
async function getExperiments(params?: object): Promise<Experiment[]> {
  try {
    ...
    const response = await fetch(
      `${apiConfig.baseURL}/experiments?${queryString}`,
      {
        method: "GET",
        headers: {
...
async function getExperiment(experimentName: string): Promise<Experiment> {
  try {
    const response = await fetch(
      `${apiConfig.baseURL}/experiments/${experimentName}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function getExperimentInfo(experimentName: string): Promise<object> {
  try {
    const response = await fetch(
      `${apiConfig.baseURL}/experiments/${experimentName}/info`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function setExperimentInfo(
...
async function getExperimentSeasons(experimentName: string): Promise<Season[]> {
  try {
    const response = await fetch(
      `${apiConfig.baseURL}/experiments/${experimentName}/seasons`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function getExperimentSites(experimentName: string): Promise<Site[]> {
  try {
    const response = await fetch(
      `${apiConfig.baseURL}/experiments/${experimentName}/sites`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function getExperimentCultivars(
  experimentName: string
): Promise<Cultivar[]> {
  try {
    const response = await fetch(
      `${apiConfig.baseURL}/experiments/${experimentName}/cultivars`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function getExperimentTraits(experimentName: string): Promise<Trait[]> {
  try {
    const response = await fetch(
      `${apiConfig.baseURL}/experiments/${experimentName}/traits`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function getExperimentSensors(experimentName: string): Promise<Sensor[]> {
  try {
    const response = await fetch(
      `${apiConfig.baseURL}/experiments/${experimentName}/sensors`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function getExperimentResources(
  experimentName: string
): Promise<Resource[]> {
  try {
    const response = await fetch(
      `${apiConfig.baseURL}/experiments/${experimentName}/resources`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function getExperimentDatasets(
  experimentName: string
): Promise<Dataset[]> {
  try {
    const response = await fetch(
      `${apiConfig.baseURL}/experiments/${experimentName}/datasets`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
