...
class DataTypeFormatModel(BaseModel):
    ...
    data_type_id: Mapped[int] = mapped_column(
        Integer, ForeignKey("gemini.data_types.id", ondelete="CASCADE")
    )
    data_format_id: Mapped[int] = mapped_column(
        Integer, ForeignKey("gemini.data_formats.id", ondelete="CASCADE")
    )
...
class ExperimentSiteModel(BaseModel):
    ...
    experiment_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=False), ForeignKey("gemini.experiments.id", ondelete="CASCADE")
    )
    site_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=False), ForeignKey("gemini.sites.id", ondelete="CASCADE")
    )
    info: Mapped[dict] = mapped_column(JSON, default={})
...
class ExperimentSensorModel(BaseModel):
    ...
    sensor_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=False), ForeignKey("gemini.sensors.id", ondelete="CASCADE")
    )
    info: Mapped[dict] = mapped_column(JSON, default={})
...
class ExperimentSensorPlatformModel(BaseModel):
    ...
    sensor_platform_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=False),
        ForeignKey("gemini.sensor_platforms.id", ondelete="CASCADE"),
    )
    info: Mapped[dict] = mapped_column(JSON, default={})
...
class ExperimentTraitModel(BaseModel):
    ...
    trait_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=False), ForeignKey("gemini.traits.id", ondelete="CASCADE")
    )
    info: Mapped[dict] = mapped_column(JSON, default={})
...
class ExperimentCultivarModel(BaseModel):
    ...
    cultivar_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=False), ForeignKey("gemini.cultivars.id", ondelete="CASCADE")
    )
    info: Mapped[dict] = mapped_column(JSON, default={})
...
class ExperimentModelModel(BaseModel):
    ...
    model_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=False), ForeignKey("gemini.models.id", ondelete="CASCADE")
    )
    info: Mapped[dict] = mapped_column(JSON, default={})
...
class ExperimentProcedureModel(BaseModel):
    ...
    procedure_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=False), ForeignKey("gemini.procedures.id", ondelete="CASCADE")
    )
    info: Mapped[dict] = mapped_column(JSON, default={})
...
class ExperimentScriptModel(BaseModel):
    ...
    script_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=False), ForeignKey("gemini.scripts.id", ondelete="CASCADE")
    )
    info: Mapped[dict] = mapped_column(JSON, default={})
...
class ExperimentDatasetModel(BaseModel):
    ...
    dataset_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=False), ForeignKey("gemini.datasets.id", ondelete="CASCADE")
    )
    info: Mapped[dict] = mapped_column(JSON, default={})
...
class PlotCultivarModel(BaseModel):
    ...
    plot_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=False), ForeignKey("gemini.plots.id", ondelete="CASCADE")
    )
    cultivar_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=False), ForeignKey("gemini.cultivars.id", ondelete="CASCADE")
    )
