...
async function getCultivars(params?: object): Promise<Cultivar[]> {
    try {
        ...
        const response = await fetch(`${flaskConfig.baseURL}/cultivars?${queryString}`, {
            method: 'GET',
            headers: {
...
async function createCultivar(params?: object): Promise<Cultivar> {
    try {
        const response = await fetch(`${flaskConfig.baseURL}/cultivars`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
async function getPopulationAccessions(cultivar_population: string): Promise<Cultivar[]> {
    try {
        const response = await fetch(`${flaskConfig.baseURL}/cultivars/${cultivar_population}/accessions`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            }
...
async function getCultivarInfo(cultivar_population: string, cultivar_accession: string): Promise<object> {
    try {
        const response = await fetch(`${flaskConfig.baseURL}/cultivars/${cultivar_population}/${cultivar_accession}/info`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            }
